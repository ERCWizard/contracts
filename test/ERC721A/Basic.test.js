...
describe('ERC721A_Basic', () => {
  ...
  beforeEach(async () => {
    ...
    await WizardFactory.connect(owner).createERC721AContract(
    ...
    createdContract = await ethers.getContractAt('ERC721A_Basic', createdContractAddress[0][2])
  })
